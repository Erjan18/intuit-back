...
class Bachelor(models.Model):
    ...
    class Meta:
        verbose_name = _("Бакалавриат")
        verbose_name_plural = _("Бакалавриат")
...
class Jobstudent(models.Model):

    class Meta:
        verbose_name = _("Трудоустройство студентов")
        verbose_name_plural = _("Трудоустройство студентов")
